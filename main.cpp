...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Eleccoin-seeder\n"
...
static const string mainnet_seeds[] = {"seed1.eleccoin.org",
                                       "seed2.eleccoin.org",
                                       "seed3.eleccoin.org",
                                       "seed4.eleccoin.org",
                                       "seed5.eleccoin.org",
                                       ...
                                       "seed10.eleccoin.org",
                                       ""};
static const string testnet_seeds[] = {"tseed1.eleccoin.org",
                                       "tseed2.eleccoin.org",
                                       "tseed3.eleccoin.org",
                                       "tseed4.eleccoin.org",
                                       ""};
...
extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 9833), true);
  }
  do {
